...
const DEFAULT_ADMIN_EMAIL = 'admin@studysync.app'
const DEFAULT_ADMIN_PASSWORD = 'StudySyncAdmin2024!'
...
export default function AdminLoginPage() {
  ...
  const handleAdminLogin = async (e: React.FormEvent) => {
    ...
    // Check default admin credentials first (case-insensitive email)
